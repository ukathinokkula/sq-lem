			...
			<div class="row">
				...
				<div class="span8">
					...
					<nav>
						<ul data-breakpoint="800" id="flexnav"
							...
							<li><a href="${pageContext.request.contextPath}/lem/admin/viewProjectDetails">
								<msg:message code="label.menu.projectDetails" /></li>
							<li><a href="${pageContext.request.contextPath}/lem/admin/viewAdminEstimations">
								<msg:message code="label.menu.estimationModelTypes" /></li>
							<li><a href="${pageContext.request.contextPath}/lem/admin/viewComplexityTypes">
								<msg:message code="label.menu.complexityTypes" /></li>
							<li><a href="${pageContext.request.contextPath}/lem/admin/openReportPage">
								<msg:message code="label.menu.reports" /></li>
						</ul>
					</nav>
					<!-- END MAIN NAVIGATION -->
				</div>
				<div class="span2">
					...
					<c:choose>
						...
						<c:when test="${username != null}">
							<ul class="login-register">
								<li><a data-effect="mfp-move-from-top" class="popup-text" href="<c:url value="/lem/j_spring_security_logout" />"> 
