...
$('[data-toggle="tooltip"]').tooltip();
	$(function($){
     $("#twitter").tweet({
       username: "revelation810", //!paste here your twitter username!
       count: 3
     });
   });
...
$(function(){
  $('#gmap').gmap3({
    marker:{
      address: "Africa Limited, 2 Salt Lake Street, Maitama, District, Abuja FCT, Nigeria" // ENTER YOUR ADDRESS HERE!
    },
    map:{
      options:{
        zoom: 14
